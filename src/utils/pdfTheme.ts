...
export function getPdfTheme(theme: AppSettings['printTheme']): PdfTheme {
  if (theme === 'github') {
    return {
      ...
      table: { width: '100%', marginBottom: 14, fontSize: 10 },
      th: { border: '1pt solid #d1d9e0', padding: 8, backgroundColor: '#f6f8fa' },
      td: { border: '1pt solid #d1d9e0', padding: 8, color: '#1f2328' },
  ...
  if (theme === 'minimal') {
    return {
      ...
      table: { width: '100%', marginBottom: 14, fontSize: 10 },
      th: { border: '1pt solid #ddd', padding: 8, fontFamily: 'Helvetica' },
      td: { border: '1pt solid #ddd', padding: 8, color: '#333' },
  ...
  return {
    ...
    table: { width: '100%', marginBottom: 14, fontSize: 10 },
    th: { border: '1pt solid #d0e8f0', padding: 8, backgroundColor: '#e8f8fa' },
    td: { border: '1pt solid #d0e8f0', padding: 8, color: '#0a1018' },
    img: { maxWidth: '100%', marginVertical: 10, borderRadius: 6 },
    pageNumber: { fontFamily: 'Inter', fontSize: 8, color: '#666' },
  };
}
